package
{
	...
	public class SuperHeavy extends Enemy
	{
		...
		public function enterFrame(e:Event)
		{
			if(time == 6)
			{
				Game.NewParticle(x+15,y-30,"WhiteGlow",1);
			}
			if(time == 12)
			{
				Game.NewParticle(x-15,y-30,"WhiteGlow",1);
		...
		public function Impact()
		{
			...
			if(impactTime < 0)
			{
				...
				Game.NewParticle(x,y,"AsteroidBits",5);
				Game.NewParticle(this.x,this.y,"DirtCloud",5);
		...
		public function remove()
		{
			if(removed == false)
			{
				...
				Game.NewBulletParticle(x+50,y+5,2);
				Game.NewBulletParticle(x-50,y-5,2);
